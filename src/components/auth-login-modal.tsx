...
export function AuthLoginModal({
  ...
  return (
    <div
      ...
      role="dialog"
    >
      <div className="w-full max-w-[32rem] rounded-[28px] border border-[var(--border-strong)] bg-[rgba(29,31,34,0.98)] p-5 shadow-[var(--shadow)] sm:p-6">
        ...
        {!emailLinkSentTo && !needsCompleteStep ? (
          <div className="space-y-3 rounded-[22px] border border-white/10 bg-white/[0.03] p-4">
            ...
            <p className="text-sm leading-6 text-[var(--muted)]">
              We will send a secure sign-in link. Open the email on this device
