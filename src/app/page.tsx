...
export default function Home() {
  ...
  <div className="tour-strip"><div className="container"><span>FOLLOW THE TOURS</span>{tourFamilies.filter(t=>t.featured).map(t=><Link key={t.id} href={`/tournaments?brand=${t.id}`}>{t.label}<span aria-hidden="true"> ↗</span></Link>)}<Link className="tour-strip-more" href="/tournaments">All tours</Link></div></div>
