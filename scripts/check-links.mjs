...
const urls=[...new Set([...freerolls.flatMap(f=>f.officialLinks.map(l=>l.url)),...tours.map(t=>t.officialUrl),...sources.map(s=>s.url),...festivals.flatMap(f=>[f.registrationUrl,f.scheduleUrl,f.venue.url].filter(Boolean))])];
